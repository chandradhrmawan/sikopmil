    ...
    <div class="modal-content">
      ...
      <div class="modal-body form">
        <form action="#" id="form" class="form-horizontal">
          <input type="hidden" value="" name="id_supir"/> 
          <div class="form-body">
...
<script src="<?=base_url()?>assets/admin/bower_components/jquery/dist/jquery.min.js"></script>
    ...
    $(document).ready(function() { 
      ...
      table = $('#table').DataTable({ 
        ...
        "ajax": {
          "url": "<?php echo base_url() ?>master/Supir/list_data",
          "type": "POST"
    ...
    function save()
    {
      ...
      if(save_method == 'add') 
      {
        url = "<?php echo site_url('master/Supir/ajax_add')?>";
        pesan = "Tambah Data";
      }
      else
      {
        url = "<?php echo site_url('master/Supir/ajax_update')?>";
        pesan = "Edit Data";
      }
     ...
     function edit_data(id)
     {
      ...
      $.ajax({
        url : "<?php echo site_url('master/Supir/ajax_get_data_by_id')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
    ...
    function delete_data(id){
      ...
      function(isConfirm){
        if (isConfirm){
          $.ajax({
            url : "<?php echo site_url('master/Supir/delete_via_ajax')?>",
            type: "POST",
            data:{"id":id},
            dataType: "JSON",
          success: function(data)
