...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2020 at 05:26 PM
...
(1, 'Kendaraan Tempur'),
(2, 'Kendaraan Taktis'),
(3, 'Kendaraan Logistik Tempur'),
(4, 'Kendaraan Angkut Personel'),
(5, 'Kendaraan Sipil'),
(6, 'Truck'),
(7, 'Jeep');
...
(4, '1', '2020-11-16 00:00:00.000000', NULL, 1),
(5, '2', '2020-11-13 00:00:00.000000', NULL, 1);
...
--
ALTER TABLE `mst_merk`
  MODIFY `id_merk` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `mst_tipe`
  MODIFY `id_tipe` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tx_jadwal_service`
  MODIFY `id_jadwal` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
