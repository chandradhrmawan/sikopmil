...
class Role extends CI_Controller {
	...
	var $table = 'mst_role';
	var $pk    = 'id_role';
	var $field = array('id_role','nm_role');

	//param for view
	var $view_list = array('No','Nama Role','Action');
	...
	public function list_data()
	{
		...
		foreach ($list as $regulasi) {
			...
			$row[] = '<a  href="#" title="Edit" onclick="edit_data('."'".$regulasi->id_role."'".')" >
						<i class="fa fa-pencil"></i> Edit
					  </a> &nbsp; |		 
					  <a class="delete" href="#" title="Delete" onclick="delete_data('."'".$regulasi->id_role."'".')" >
	...
	public function ajax_update()
	{
		...
		$update =  $this->crud_model->update($this->table,$this->pk,$this->input->post('id_role'),$data);
