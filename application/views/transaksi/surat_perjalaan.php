<?php
	...
	$panel_4 = '<div class="container_1">
				<table border="1" cellspacing="2" cellpadding="2">
				<tr>
				<td>
					<table border="'.$border.'" cellspacing="2" cellpadding="2" width="100%">
						<tr>
							<td width="25%"><h2><u>Data Pengembalian</u></h2></td>
							<td></td>
							<td rowspan="7">
							</td>
						</tr>
						<tr>
							<td><h2>Total Biaya : </h2></td>
							<td><h2>'.$data_pengembalian->total_biaya.'</h2></td>
						...
						<tr>
							<td><h2>Tanggal Pengembalian </h2></td>
							<td><h2>'.view_date_hi($data_pengembalian->tgl_pengembalian).'</h2></td>
