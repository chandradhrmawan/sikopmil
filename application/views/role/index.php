        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="nm_role" id="nm_role" placeholder="Nama Role" class="form-control" type="text">
             </div>
           </div>
...
<script src="<?=base_url()?>assets/admin/bower_components/jquery/dist/jquery.min.js"></script>
    ...
    $(document).ready(function() { 
      ...
      table = $('#table').DataTable({ 
        ...
        "ajax": {
          "url": "<?php echo base_url() ?>master/Role/list_data",
          "type": "POST"
    ...
    function save()
    {
      ...
      if(save_method == 'add') 
      {
        url = "<?php echo site_url('master/Role/ajax_add')?>";
        pesan = "Tambah Data";
      }
      else
      {
        url = "<?php echo site_url('master/Role/ajax_update')?>";
        pesan = "Edit Data";
      }
     ...
     function edit_data(id)
     {
      ...
      $.ajax({
        url : "<?php echo site_url('master/Role/ajax_get_data_by_id')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
    ...
    function delete_data(id){
      ...
      function(isConfirm){
        if (isConfirm){
          $.ajax({
            url : "<?php echo site_url('master/Role/delete_via_ajax')?>",
            type: "POST",
            data:{"id":id},
            dataType: "JSON",
          success: function(data)
